...
Describe 'Select-Object' {
    ...
    It 'changes the object type' {
        ...
        # $Folder | Should -BeOfType Directory
        ...
        # 'System.Management.Automation.PSCustomObject' | Should -BeIn $Selected.PSTypeNames
    }
    ...
    It 'can merge the properties of a nested object with properties from the parent' {
        ...
        # $Selected.Name | Should -Be $PowerShellExe.FullName
    }
    ...
    It 'supports custom, or calculated, properties' {
        ...
        $Selected.RunningTime | Should -BeGreaterThan 0
