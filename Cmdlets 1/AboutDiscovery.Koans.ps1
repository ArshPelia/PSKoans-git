...
Describe 'Get-Command' {
    ...
    It 'can look for commands by verb' {
        ...
        443 | Should -Be $GetCommands.Count

        'Get-AppPackageLastError' | Should -Be $GetCommands[4].Name
    }
    ...
    It 'can look for commands by module' {
        ...
        @('Clear-Path', 'Get-Advice', 'Get-Blank',
'Get-Enlightenment') | Should -Be $First4Commands.Name
    }
}
