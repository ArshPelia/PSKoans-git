...
Describe 'Strings' {
    ...
    Context 'Literal Strings' {
        ...
        It 'can contain special characters' {
            ...
            "$complexVar" | Should -Be $complexVar
        }
    ...
    Context 'Evaluated Strings' {
        ...
        It 'can expand variables' {
            $var = 'apple'
            "My favorite fruit is $var" | Should -Be "My favorite fruit is $var"
        }

        It 'can do a simple expansion' {
            "Your home directory is: $HOME" | Should -Be "Your home directory is: $HOME"
        }
        ...
        It 'will expand variables that do not exist' {
            ...
            "PowerShell's home folder is: $SPHome" | Should -Be $String
        }
...
'@ # This terminating sequence must be at the start of the line.
            ...
            $LiteralString | Should -Be $LiteralString
        }
...
"@
            $AllYourQuotes | Should -Be $AllYourQuotes
        }
    }
