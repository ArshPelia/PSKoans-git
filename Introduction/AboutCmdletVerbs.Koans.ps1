...
Describe "Basic Verbs" {
    ...
    BeforeAll {
        ...
        $FilePath = "C:\Users\apeli\Powershell-Practice\PSKoans\Verbs.txt";
    ...
    Context "Add" {
        ...
        It 'is for commands that append data' {
            ...
            #>
            $Answers = "Add-DnsClientNrptRule", "Add-NetEventNetworkAdapter", "Add-OdbcDsn", "Add-VpnConnection", "Add-VMDirectVirtualDisk"
        ...
        It 'can Add-Content to a file' {
            ...
            'Hello' | Add-Content -Path $FilePath
            '1' | Add-Content -Path $FilePath
            '2' | Add-Content -Path $FilePath
    ...
    Context "Set" {
        ...
        It 'is for commands that overwrite data' {
            ...
            #>
            $Answers = "Set-WSManInstance", "Set-WinSystemLocale", "Set-WheaMemoryPolicy", "Set-TraceSource", "Set-WindowsProductKey"
    ...
    Context "Remove" {
        ...
        #>
            $Answers = "Remove-WindowsPackage", "Remove-LocalUser", "Remove-CimSession", "Remove-BcdEntry", "Remove-CimSession"
